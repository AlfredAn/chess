...
public class TemplatePieceJUnitTest {
  ...
  public void testSingleMoves() {
    ...
    MoveSet moveList = piece.getAvailableMoves();
  ...
  public void testSingleMoveOntoEnemy() {
    ...
    MoveSet moveList1 = piece1.getAvailableMoves();
    ...
    MoveSet moveList2 = piece2.getAvailableMoves();
  ...
  public void testRepeatableMoveOntoEnemy() {
    ...
    MoveSet moveList = piece1.getAvailableMoves();
